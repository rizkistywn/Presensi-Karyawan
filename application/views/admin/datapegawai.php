                ...
                <table class="table table-bordered" id="datapegawai" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th>Level</th>
                            <th>Shift Bagian</th>
                            <th>MAC Address Laptop</th>
                            <th>MAC Address HP</th>
                            <th>Verifikasi</th>
                            <th>Aksi</th>
                        </tr>
                    </thead>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <label for="laptop_mac_address" class="col-sm-4 col-form-label">Laptop MAC Address</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="laptop_mac_address" name="laptop_mac_address">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="hp_mac_address" class="col-sm-4 col-form-label">HP MAC Address</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="hp_mac_address" name="hp_mac_address">
                    </div>
                </div>
                <div class="form-group row">
